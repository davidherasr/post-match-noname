...
def main() -> None:
    generate_sample()
    full_pdf = ROOT / "sample" / "informe_demo_postmatch_scout_2_1_completo.pdf"
    executive_pdf = ROOT / "sample" / "informe_demo_postmatch_scout_2_1_ejecutivo.pdf"
    ...
    print(f"OK · Smoke test 2.1 · completo={full_pdf.stat().st_size} bytes · ejecutivo={executive_pdf.stat().st_size} bytes")
