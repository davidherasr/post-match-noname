...
def render(user: dict) -> None:
    page_header("Administración", "Usuarios, identidad, seguridad, almacenamiento, auditoría y recuperación operativa.")
    tab_users, tab_brand, tab_security, tab_storage, tab_audit, tab_backup = st.tabs([
        "Usuarios", "Identidad", "Seguridad", "Documentos", "Auditoría", "Backup"
    ])
    ...
    with tab_brand:
        ...
        with st.form("brand_form"):
            ...
            pdf_default = st.selectbox("PDF por defecto", ["executive", "full"], index=0 if app_settings.get("pdf_default_mode", "executive") == "executive" else 1, format_func=lambda v: "Ejecutivo" if v == "executive" else "Completo")
